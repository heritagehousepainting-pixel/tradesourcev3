...
export default function TermsOfService() {
  ...
  const sections = [
    ...
    { id: 'dispute-resolution', title: 'Dispute Resolution', content: `TradeSource is a contractor marketplace platform. We do not employ contractors, manage projects, or participate in transactions between contractors and property owners.

TradeSource does not resolve disputes.

Any dispute, disagreement, or claim arising from work performed or agreed upon between contractors and property owners — including but not limited to quality of workmanship, missed deadlines, payment disputes, property damage, or personal injury — must be resolved directly between the parties involved. TradeSource assumes no responsibility for, and will not mediate, arbitrate, or otherwise involve itself in such disputes.

We strongly encourage all parties to document agreements in writing before commencing work and to contact local authorities if a criminal matter is involved.` },
