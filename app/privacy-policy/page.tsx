    ...
    <div className="min-h-screen" style={{ backgroundColor: '#0D1B2A' }}>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-10">
        ...
        <div className="mt-8 text-center" style={{ fontSize: '14px', color: 'rgba(248,250,252,0.3)' }}>
          Questions? Contact us at <a href="mailto:privacy@tradesource.co" className="underline" style={{ color: '#60A5FA' }}>privacy@tradesource.co</a>
        </div>
      </div>
    </div>
  )
