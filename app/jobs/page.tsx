...
const DEMO_JOBS = [
  { id: 'demo-1', title: 'Interior Repaint — 4BR Colonial, Ambler', description: 'Full interior repaint on a 1970s colonial in Ambler. All walls, ceilings, trim, and doors to be painted. Colors: SW Alabaster walls, Extra White trim. Two coats throughout. All nail holes filled, surfaces sanded. Brush and roll only.', area: 'Ambler, PA', scope: 'Interior', budget_min: 5350, status: 'open', poster_id: 'demo-contractor', created_at: new Date(Date.now() - 1 * 86400000).toISOString() },
  { id: 'demo-2', title: 'Kitchen + Hallway — Rental Turnover, Center City', description: 'Rental turnover repaint in a Center City Philadelphia rowhome. Kitchen cabinets (boxes stay, doors/frames painted), full hallway, one bedroom. Eggshell on walls, Semi-Gloss on trim. Fast turnaround — 3 days max. Odor blocking primer on ceiling expected.', area: 'Philadelphia, PA', scope: 'Interior', budget_min: 2300, status: 'open', poster_id: 'demo-contractor', created_at: new Date(Date.now() - 2 * 86400000).toISOString() },
  { id: 'demo-3', title: 'Cabinet Painting — White Shaker, Doylestown Flip', description: 'Flip project in Doylestown. 18 upper and lower shaker cabinets. Sand, prime, and spray 2 coats BM Advance Satin in White. Interior of cabinets coated once. Hardware removed and reinstalled. Trim and casings also included.', area: 'Doylestown, PA', scope: 'Cabinet Painting', budget_min: 2800, status: 'open', poster_id: 'demo-contractor', created_at: new Date(Date.now() - 3 * 86400000).toISOString() },
  { id: 'demo-4', title: 'Interior Repaint — 3BR Condo, Jenkintown', description: '3BR/2BA condo repaint in Jenkintown. Living room, kitchen, hallways, two bedrooms. Matte on walls, satin on trim. Building work hours start at 9am. Parking in lot. 6-foot ceilings, mostly good condition.', area: 'Jenkintown, PA', scope: 'Interior', budget_min: 2550, status: 'open', poster_id: 'demo-contractor', created_at: new Date(Date.now() - 1 * 86400000).toISOString() },
  { id: 'demo-5', title: 'Full Exterior Repaint — 1950s Cape Cod, Marcus Hook', description: 'Complete exterior repaint on a 1950s cape cod in Marcus Hook. Wood clapboard front, vinyl sides and rear. All trim, shutters, and front door. Door needs proper enamel prep. Aluminum coil wrap on fascia cleaned and spot-primed.', area: 'Marcus Hook, PA', scope: 'Exterior', budget_min: 6350, status: 'open', poster_id: 'demo-contractor', created_at: new Date(Date.now() - 2 * 86400000).toISOString() },
  { id: 'demo-6', title: 'Exterior Soft Wash — Townhome End Unit, Manayunk', description: 'Soft wash and hand-scrub on end-unit townhome in Manayunk. Vinyl siding, brick front foundation, concrete walkway. Algae and mildew on north-facing elevation. Soft wash only — do not pressure wash vinyl. 1.5% NaOCl solution with surfactant.', area: 'Manayunk, PA', scope: 'Power/Wash', budget_min: 600, status: 'open', poster_id: 'demo-contractor', created_at: new Date(Date.now() - 3 * 86400000).toISOString() },
]
